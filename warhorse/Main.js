...
const War = createApp({
  ...
  methods: {
    ...
    saveGame() {
      // set up save
      global.myHorses = this.myStable.horses;
      global.enemyHorses = this.enemyStable.horses;
      global.RIP = this.RIPlist;
      //global.enemyHorses = this.enemyStable.horses;
...
War.component('horse-list-item', {
  ...
  methods: {
    ...
    choose() {
      this.$root.chooseHorse(this.horse);
    },
    battle() {
      this.$root.chooseEnemy(this.horse);
    }
  }
});
